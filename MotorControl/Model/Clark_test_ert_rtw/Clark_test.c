...
void Clark_test_step(void)
{
   ...
   *  Sum: '<S3>/Add'
   */
  ia = arm_sin_f32(-rt_modf_snf((real32_T)(rtb_Mod + 2.0943951023931953),
    6.28318548F));
   ...
   *  Sum: '<S3>/Add1'
   */
  ib = arm_sin_f32(-rt_modf_snf((real32_T)rtb_Mod, 6.28318548F));

  /* Trigonometry: '<S3>/Sin2' incorporates:
   *  Constant: '<S3>/Constant5'
   *  DataTypeConversion: '<S3>/Cast To Single2'
   *  Gain: '<S3>/Gain2'
   *  Math: '<S3>/Mod2'
   *  Sum: '<S3>/Add2'
   */
  ic = arm_sin_f32(-rt_modf_snf((real32_T)(rtb_Mod - 2.0943951023931953),
    6.28318548F));
   ...
   *  MATLAB Function: '<S1>/Clark'
   */
  rtY.ialpha = ((2.0F * ia - ib) - ic) / 3.0F;

  /* Outport: '<Root>/ibeta' incorporates:
   *  MATLAB Function: '<S1>/Clark'
   */
  rtY.ibeta = (ib - ic) * 1.73205078F / 3.0F;
